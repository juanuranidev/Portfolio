...
const About = () => {
  return (
    <main className='sobreMi' id='main'>
        ...
        <p>Actualmente estoy en busca de mi primer empleo en este sector mientras realizo una gran variedad de proyectos personales de distintas dificultades y sigo aprendiendo diariamente.</p>
    </main>
  )
}
